...
__C.DATASET.COMPETITION = CN()
__C.DATASET.COMPETITION.ROOT = ''
__C.DATASET.COMPETITION.FRAME_RANGE = 100
__C.DATASET.COMPETITION.NUM_USE = -1
...
__C.BACKBONE.TYPE = 'mobileone_s2'

__C.BACKBONE.KWARGS = CN(new_allowed=True)

# Pretrained backbone weights
__C.BACKBONE.PRETRAINED = 'mobileone_s2_unfused.pth.tar'

# Train layers
__C.BACKBONE.TRAIN_LAYERS = ['stage2', 'stage3', 'fusion_proj', 'contract_reduce', 'head_proj']
